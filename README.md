...
[![npm version](https://img.shields.io/npm/v/@hibadawood25/cli-number-guessing-game.svg?style=flat-square)](https://www.npmjs.com/package/@hibadawood25/cli-number-guessing-game)
...
```bash
npx @hibadawood25/cli-number-guessing-game
